...
def mouse_move_callback(w, x, y):
    ...
    if mouse_button_pressed:
        rotation_y+=(x-last_mouse_x)*0.2
        rotation_x+=(y-last_mouse_y)*0.2
    elif middle_mouse_pressed:
        pan_x+=(x-last_mouse_x)*0.01
        pan_y-=(y-last_mouse_y)*0.01
    last_mouse_x=x
    last_mouse_y=y
...
def create_shader():
    ...
    try:
        ...
        _gv=glGenVertexArrays(1)
        glBindVertexArray(_gv)
        b=glGenBuffers(1)
